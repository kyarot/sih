          ...
          <View style={styles.actionsSection}>
            ...
            >
              ...
              >
                ...
                <Text style={styles.primaryButtonSubtext}>Create New Account</Text>
              </LinearGradient>
            </TouchableOpacity>
...
export function HomeScreenAlternative() {
  const navigation = useNavigation<HomeScreenProp>();
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={[styles.container, { backgroundColor: "#1E40AF" }]}>
        ...
        <View style={styles.actionsSection}>
          <TouchableOpacity
            style={[alternativeStyles.primaryButtonAlt, styles.shadowEffect]}
            onPress={() => navigation.navigate("Auth")}
            activeOpacity={0.8}
          >
            <Text style={styles.primaryButtonText}>Get Started</Text>
...
// Additional styles for alternative version
